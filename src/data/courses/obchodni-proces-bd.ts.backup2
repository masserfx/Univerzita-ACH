...
8. Zjišťovat potřeby a obavy, vzbuzovat důvěru, motivovat
9. Technické dotazy odkládat na pozdější individuální konzultace

## Cíl / Výstup
1. Odsouhlasení změny vytápění
2. Pověření výboru k uzavření smlouvy

## <span style="color: #FF0000;">POZOR!</span>
- Jeden připravuje, druhý mluví
- Jeden mluví, druhý sleduje
- Výbor spolupracuje, je infiltrován mezi lidi, potvrzuje předchozí kroky`
    },
    {
      id: 'smlouva-a-predani',
      title: 'Smlouva a předání',
      content: `# Smlouva a předání
## Smlouva
1. <span style="color: #FF0000;">SMLOUVU K PODPISU DOŘEŠÍ OBCHODNÍK</span> (dokud není podepsaná smlouva, není obchod)
2. Vzor smlouvy najdete zde:
   <span style="color: #0000FF;">Z:\\Obchod - ČR\\+ BYTOVÉ DOMY\\SoD, servisní smlouva, garance</span>
3. Přílohy zajišťuje:
   - Obchodník
   - Technik
   - Podpora ve společné kooperaci
4. Nestandardní věci ve smlouvě je nutné poznamenat do karty zákazníka v EVI
   - Například: specifika budoucího servisu a technické podpory

## Předání
1. <span style="color: #FF0000;">DALŠÍ ÚČAST OBCHODNÍKA JE NA PŘEDÁNÍ AKCE</span>
2. Oficiální předání:
   - Probíhá po kolaudaci
   - PROMO AKCE S OBČERSTVENÍM
3. Po měsíci:
   - Schůzka – provize a provozní data
   - <span style="color: #FF0000;">PŘI PŘEDÁNÍ ROVNOU DOMLOUVÁ REFERENCI</span>`
    }
  ]
}; 